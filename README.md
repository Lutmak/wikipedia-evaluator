...
```bash
# Clone repository
git clone git@github.com:Lutmak/wikipedia-evaluator.git
...
# Optionally if you cannot activate the .venv for some reason you can run it directly:
...
### Access Points
- **Frontend Interface**: http://localhost:7860 -> gradio interface 
- **API Documentation**: http://localhost:8000/docs -> autogenerated by fastAPI
